...
df.to_csv('R1_dataset.csv')
#print(df.head())

###############################################################################

#idk what's happening here, is it just for examples/visualization? seems like
dim = len(classes)
...
###############################################################################
# is everything above not actually needed? nope still need at least some of it
###############################################################################
